...
@section('title', 'Tambah Grup Email')
@section('page-title', 'Tambah Grup Email')
...
<div class="max-w-2xl">
    ...
    <div class="flat-card p-6">
        <h2 class="font-mono text-sm font-semibold text-slate-800 dark:text-white mb-5">Buat Grup Email Baru</h2>

        <form action="{{ route('admin.crm.groups.store') }}" method="POST" class="space-y-4" id="group-form">
            @csrf

            @include('admin.crm.groups._form')

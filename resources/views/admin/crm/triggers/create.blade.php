...
@section('title', 'Tambah Trigger Email')
@section('page-title', 'Tambah Trigger Email')
...
<div class="max-w-2xl">
    ...
    <div class="flat-card p-6">
        <h2 class="font-mono text-sm font-semibold text-slate-800 dark:text-white mb-5">Buat Trigger Email Baru</h2>

        <form action="{{ route('admin.crm.triggers.store') }}" method="POST">
            @csrf

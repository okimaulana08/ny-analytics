...
<div class="flex h-full min-h-screen">
    ...
    <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 z-30 w-60 flex-shrink-0 flex flex-col bg-[#0f172a] dark:bg-[#080a10] -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out border-r border-white/[0.06]">
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
            ...
            <div class="text-white/20 text-[10px] font-semibold px-3 py-2 mt-3 uppercase tracking-widest">Laporan</div>
            ...
            <a href="{{ route('admin.reports.user-journey') }}" class="nav-link {{ request()->routeIs('admin.reports.user-journey') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.reports.chapter-dropoff') }}" class="nav-link {{ request()->routeIs('admin.reports.chapter-dropoff') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.reports.authors') }}" class="nav-link {{ request()->routeIs('admin.reports.authors*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.reports.revenue-daily') }}" class="nav-link {{ request()->routeIs('admin.reports.revenue-daily') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.reports.revenue-forecast') }}" class="nav-link {{ request()->routeIs('admin.reports.revenue-forecast') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.reports.user-daily') }}" class="nav-link {{ request()->routeIs('admin.reports.user-daily') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                </svg>
            ...
            <div class="text-white/20 text-[10px] font-semibold px-3 py-2 mt-3 uppercase tracking-widest">CRM Tools</div>

            <a href="{{ route('admin.crm.broadcast.create') }}" class="nav-link {{ request()->routeIs('admin.crm.broadcast.*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.crm.individual.create') }}" class="nav-link {{ request()->routeIs('admin.crm.individual.*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.crm.groups.index') }}" class="nav-link {{ request()->routeIs('admin.crm.groups.*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                </svg>
                Email Groups
            ...
            <a href="{{ route('admin.crm.templates.index') }}" class="nav-link {{ request()->routeIs('admin.crm.templates.*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Email Templates
            ...
            <a href="{{ route('admin.crm.campaigns.index') }}" class="nav-link {{ request()->routeIs('admin.crm.campaigns.*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.crm.triggers.index') }}" class="nav-link {{ request()->routeIs('admin.crm.triggers.*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.crm.wa-triggers.index') }}" class="nav-link {{ request()->routeIs('admin.crm.wa-triggers.*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.crm.scheduled-reports.index') }}" class="nav-link {{ request()->routeIs('admin.crm.scheduled-reports.*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-white/20 text-[10px] font-semibold px-3 py-2 mt-3 uppercase tracking-widest">Export</div>
            ...
            <a href="{{ route('admin.communication-logs') }}" class="nav-link {{ request()->routeIs('admin.communication-logs*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.system-config') }}" class="nav-link {{ request()->routeIs('admin.system-config*') ? 'active' : '' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
